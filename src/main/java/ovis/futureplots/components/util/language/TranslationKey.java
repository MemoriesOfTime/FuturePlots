...
public enum TranslationKey {
    ...
    FLAG_NOT_EXIST,
    FLAG_NOT_SUPPORT_PARAMETER,
    FLAG_SPECIFY_MATERIAL,
    FLAG_MATERIAL_NOT_EXIST,
    FLAG_MATERIAL_EXIST,
    FLAG_MATERIAL_ADDED,
    FLAG_REMOVED,
    FLAG_REMOVED_VALUE,
    FLAG_VALUE_NULL,
    FLAG_VALUE_NOT_REMOVED,
    FLAG_VALUE_NOT_CONTAINS,
    FLAG_SET_CHANGED,

    FLAG_LIST_TITLE,
    FLAG_LIST_TYPE_BLOCKTYPELIST,
    FLAG_LIST_TYPE_BOOLEAN,
